...
SELECT c.FullName, b.BookingID FROM Customers c JOIN Bookings b ON (c.CustomerID = b.CustomerID) WHERE BookingDate = '2021-11-11';
...
SELECT BookingDate, COUNT(BookingID) FROM Bookings GROUP BY BookingDate;
...
REPLACE Courses SET ("Kabasa", 20.00);
...
CREATE PROCEDURE GetBookingsData(IN InputDate VARCHAR(15)) 
    BEGIN
